...
//			getTasks(); // Install monitoring on any new tasks that will be created.
		}catch(NodeExistsException nee)
		{
			...
			isMaster=false;
			String name = zk.create("/dist30/workers/worker-", "".getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL_SEQUENTIAL, null);
	...
	void runForMaster() throws UnknownHostException, KeeperException, InterruptedException
	{
		...
		zk.create("/dist30/master", pinfo.getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL);
	}
